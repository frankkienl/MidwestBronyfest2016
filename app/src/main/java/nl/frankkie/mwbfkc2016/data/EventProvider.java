package nl.frankkie.mwbfkc2016.data;
        ...
        switch (match) {
            ...
            case EVENT: {
                ...
                if (id != -1L) { //return -1 on error
                    ...
                    throw new SQLException("Failed to insert Event row into: " + uri);
                }
                break;
            }
            case LOCATION: {
            ...
            case SPEAKER: {
                ...
                if (id != -1L) {
                    ...
                    throw new SQLException("Failed to insert Speaker row into: " + uri);
                }
                break;
            }
            case SPEAKERS_IN_EVENTS: {
                ...
                if (id != -1L) {
                    ...
                    throw new SQLException("Failed to insert SpeakersInEventsEntry row into: " + uri);
                }
                break;
            }
            case FAVORITES: {
